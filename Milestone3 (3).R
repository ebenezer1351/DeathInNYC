...
Causes$Age_Adjusted_Death_Rate<-as.numeric(gsub("[\\.,]","",Causes$Age_Adjusted_Death_Rate))
...
hist(Causes$Age_Adjusted_Death_Rate,main = "Histogram of Age Adjusted Death Rate",xlab= "Age Adjusted Death Rate",ylab="Frequency")
